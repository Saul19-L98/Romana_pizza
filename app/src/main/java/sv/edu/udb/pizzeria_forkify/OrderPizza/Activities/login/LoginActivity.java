...
public class LoginActivity extends AppCompatActivity {
                ...
                if (awesomeValidation.validate()){
                    ...
                    firebaseAuth.signInWithEmailAndPassword(mail,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            //Verificamos si el login se realizo

                            if (task.isSuccessful()){
                                Toast.makeText(LoginActivity.this,"Bienvenido "+mail, Toast.LENGTH_SHORT).show();
                                go_LanginMenu();

                            }else {
                                //Se camptura el codigo y se manda la funcion para imprimir el mensaje de error correspondiente
                    ...
                    Toast.makeText(LoginActivity.this, "Ingresa todos los datos...!!",Toast.LENGTH_SHORT).show();
                }
            }
        });

        //Redireccionamineto al activity Registrar
        btn_registrar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginActivity.this, RegisterActivity.class);
    ...
    protected void onStart() {
        //verificacion de una sesion abierta
    ...
    //intent para al menu principal
    private void go_LanginMenu() {
        Intent intent = new Intent(this, LandingMenuActivity.class);
